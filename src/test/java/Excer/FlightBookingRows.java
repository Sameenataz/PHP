//Program to go to phptravel.et website, click on flight tab, ebter field data from excel sheet and
...
public class FlightBookingRows {
...
//            adult = Integer.parseInt(sadult.trim());
        ...
        //Thread.sleep(5000);
//        Select listbox = new Select(driver.findElement(By.xpath("//select[@name= 'cabinclass']")));
//        System.out.println("option:"+listbox.getOptions());
...
//        }
        for(int s=1;s<=3;s++) {
            ...
            driver.findElement(By.xpath("//a[@data-name = 'flights']")).click();
            Thread.sleep(5000);
            driver.findElement(By.xpath("//*[@id=\"flights\"]/div/div/form/div/div/div[1]/div[2]/div/div/a/span")).click();
            Thread.sleep(5000);
            driver.findElement(By.xpath("//ul[@class = 'chosen-results']/li["+s+"]")).click();
