//Program to go to phptravel.et website, click on flight tab, enter field data from excel sheet for all rows and
// search for flights and display the flight count for each row
package Excer;
...
public class FlightBookingMulti {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("number of rows in the input sheet:"+rows);
        for(r=2;r<=rows;r++) {
            ...
            Thread.sleep(5000);
            String from1 = reader.getCellData(sheetName, 0, r);
            String to = reader.getCellData(sheetName, 1, r);
            String depart = reader.getCellData(sheetName, 2, r);
            String sadult = reader.getCellData(sheetName, 3, r);
            String schild = reader.getCellData(sheetName, 4, r);
            String sinfant = reader.getCellData(sheetName, 5, r);
            int adult = 0;
            int child = 0;
            int infant = 0;
