//Program to go to phptravel.et website, click on flight tab, enter field data from excel sheet and
// search for flights and display the flight count
//
package Excer;
...
public class FlightBookingSingle {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Xls_Reader1 reader = new Xls_Reader1("./src/main/java/booking.xlsx");
...
//            adult = Integer.parseInt(sadult.trim());
        ...
        while(true){
            ...
            String defdate = driver.findElement(By.xpath("//*[@id=\"datepickers-container\"]/div[9]/nav/div[2]")).getText();
        ...
        while(m<42){
            ...
            pageday = driver.findElement(By.xpath("//*[@id=\"datepickers-container\"]/div[9]/div/div/div[2]/div["+m+"]")).getText();
            System.out.println(driver.findElement(By.xpath("//*[@id=\"datepickers-container\"]/div[9]/div/div/div[2]/div["+m+"]")).getText());
            //if(day.equals(pageday)){
            System.out.println("before compare"+pageday+"---"+day);
            if(Integer.parseInt(day) == Integer.parseInt(pageday)){
                System.out.println("Inside if -compare dates");
                Thread.sleep(5000);
                driver.findElement(By.xpath("//*[@id=\"datepickers-container\"]/div[9]/div/div/div[2]/div["+m+"]")).click();
                break;
            }
            m++;
        }
